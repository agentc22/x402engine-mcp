...
function createServer() {
    ...
    server.tool("get_crypto_categories", "List CoinGecko category IDs for sector discovery and downstream market filters. $0.001 per request.", {}, async () => {
    ...
    server.resource("services", "x402engine://services", async (uri) => {
        ...
        const discoveryData = (discoveryRes?.data ?? null);
        const servicesData = (servicesRes?.data ?? null);
